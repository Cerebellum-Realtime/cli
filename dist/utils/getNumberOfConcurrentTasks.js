...
const getNumberOfConcurrentTasks = async () => {
    try {
        ...
        while (true) {
            const input = await cli.prompt("How many tasks (app servers) would you like concurrently running");
        ...
        console.log(`🧠 Confirming ${numOfConcurrentTasks} tasks will be concurrently running!`);
